...
[v4.13–v4.16 成熟度提升技术方案](maturity-evolution-plan.zh-CN.md)。
...
| 契约安全加固 | v4.13 计划 | 成功要求、失败尝试上限和未声明状态变化检查 |
| 留出数据验证 | v4.14 计划 | 冻结规则、决策与评分隔离、可追溯 benchmark manifest |
| 独立项目接入 | v4.15 计划 | 独立消费仓库、发布包接入和三类真实错误注入 |
