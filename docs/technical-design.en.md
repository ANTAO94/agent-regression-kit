...
Based on v4.30.0 source. Package version 4.30.0, PUBLIC_API_VERSION=4 and Trace/Session/Contract/Report schema=0.1 are independent compatibility boundaries; benchmark manifest/decision/score/performance/study use their own schema 0.1.
...
Current release: [v4.30.0](https://github.com/ANTAO94/agent-regression-kit/releases/tag/v4.30.0).
