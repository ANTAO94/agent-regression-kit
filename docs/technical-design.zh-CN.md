...
依据 v4.35.1 源码整理；产品版本 4.35.1、PUBLIC_API_VERSION=4、AgentTrace/AgentSession/Contract/Report schema=0.1 是相互独立的兼容边界；Benchmark manifest/decision/score/performance/study/readiness 另有独立 schema=0.1。
...
当前发布：[v4.35.1](https://github.com/ANTAO94/agent-regression-kit/releases/tag/v4.35.1)。
