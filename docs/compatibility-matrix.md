...
| τ²-bench published results | tag `v1.0.1`, SHA-256-pinned half-duplex retail file | 420 write scenarios + dedicated independent-project workflow | Reward is hidden until after Contract evaluation; no upstream adoption claim and no voice/domain-wide coverage. |
