...
当前版本：[v4.6.0](https://github.com/ANTAO94/agent-regression-kit/releases/tag/v4.6.0)。Python ≥3.9，核心无必需第三方运行时依赖，MIT 开源。
...
| 下载 | [wheel 与源码包](https://github.com/ANTAO94/agent-regression-kit/releases/tag/v4.6.0) |
...
Release: [v4.6.0](https://github.com/ANTAO94/agent-regression-kit/releases/tag/v4.6.0). Python ≥3.9, no required third-party core runtime dependencies, MIT license.
...
Recorded v4.6.0 evidence is maintained by the main regression, framework compatibility, path-variation, live-provider and release workflows; each release also includes local full-test, wheel-build, compatibility, migration and clean-install checks.
