...
class CiIntegrationTests(unittest.TestCase):
    ...
    def test_core_workflow_uses_isolated_ci_report_directory(self):
        ...
        self.assertIn("Verify study evidence index blocks source tampering", workflow)
        self.assertIn("order-123-study-source-tampered", workflow)
        self.assertIn("adapter-descriptor.json", workflow)
        self.assertIn("Verify study evidence bindings block semantic mismatch", workflow)
        self.assertIn("order-123-study-semantic-tampered", workflow)
        self.assertIn("input_sha256", workflow)
    ...
    def test_release_workflow_runs_source_tests_with_package_path(self):
        ...
        self.assertIn("v4.31-acceptance.md", workflow)
        self.assertIn("v4.32-acceptance.md", workflow)
    ...
    def test_langgraph_external_workflow_checks_patch_version(self):
