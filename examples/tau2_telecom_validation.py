"""Validate Agent Regression Kit against pinned tau2-bench telecom results."""
...
from agent_regression import evaluate_tau2_telecom_results, trace_from_tau2_simulation
...
def main() -> int:
    ...
    parser.add_argument("--min-eligible", type=int, default=300)
    ...
    try:
        ...
        print(f"tau2 telecom validation input error: {exc}", file=sys.stderr)
        return 2
